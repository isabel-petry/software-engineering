...
public class Menu implements Serializable {
	...
	public static void menu_admin(Usuario usuarioLogado)
		...
		while (true) {
			...
			case "6":
				...
				break;
			case "7":
				menuChat(usuarioLogado, scanner);
				break;
			case "8":
	...
	public static void menu_membro(Usuario usuarioLogado)
			throws URISyntaxException, SQLException, ClassNotFoundException {
		Scanner scanner = new Scanner(System.in);
		while (true) {
			System.out.println("\nMenu Principal:");
	...
	public static void alterar_dados_usuario(Usuario user)
			throws URISyntaxException, SQLException, ClassNotFoundException {
...
// Método para gerenciar o estoque
	...
	public static void menuChat(Usuario usuarioLogado, Scanner scanner) throws ClassNotFoundException, URISyntaxException, SQLException {
        ...
        cliente.startListening();

        System.out.println("Digite mensagens. Use /sair para sair.");
